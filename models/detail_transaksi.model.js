 ...
 */
 ...
 /** buat function utk mengurangi data pada tabel telur sesuai jumlah telur yang diisikan user */
    exports.minus = (dataObject, parameter) => {    
        return new Promise((resolve, rejected) => {
            /** create query for delete */
            let query = `UPDATE telur SET stok = stok - new.jumlah_telur
                         WHERE id_telur = new.id_telur`
